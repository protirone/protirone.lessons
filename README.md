...
stellt im Ordner der Ausbildungsrichtung die fertigen Unterrichtseinheiten in Form von PDF-Dateien zum Download bereit, sortiert nach Lernfeldern und intendierter Abfolge - bzw. bei Lernfeld-übergreifenden Lektionen: gesammelt in einem Cross-Over-Ordner.
...
Das Download-Repository [protico.lessons](https://github.com/proi-tirone-computatri/protico.lessons) stellt die fertigen Unterrichtseinheiten in einem der Ausbildung an den Berufsschulen entsprechenden Ordner zum Download bereit:

#### (4.1) Fachinformatik

* bietet in seinem Ordner für jedes Lernfeld des Rahmenlehrplans einen eigenen Unterordner z.B. `lf.03`, `lf.09`, oder `lf.11c` ] mit Unterrichtseinheiten,
